...
variance_tibble %>%
  mutate(principal_components = factor(principal_components, 
                                        levels = principal_components)) %>%
  ggplot(aes(x = principal_components)) +
  geom_bar(aes(y = variance_explained, fill = "Variance Explained"), 
           stat = "identity", alpha = 0.7) +
  geom_point(aes(y = cumulative, color = "Cumulative Variance"), group = 1) +
  geom_line(aes(y = cumulative, color = "Cumulative Variance", group = 1)) +
  scale_fill_manual(name = "", values = c("Variance Explained" = "steelblue")) +
  scale_color_manual(name = "", values = c("Cumulative Variance" = "red")) +
